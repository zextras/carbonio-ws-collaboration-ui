...
declare global {
	...
	namespace Strophe {
		...
		enum NS {
			...
			XMPP_RETRACT = 'urn:esl:message-retract-by-stanza-id:0',
		...
		class Builder {
			 ...
			 */
			constructor(name: string, attrs?: never);
...
declare interface StropheConnection {
	/**
	 * the service url to connect with
	 */
	service: string;
...
declare enum StropheConnectionStatus {
	ERROR = 0,
	CONNECTING = 1,
	CONNFAIL = 2,
	AUTHENTICATING = 3,
