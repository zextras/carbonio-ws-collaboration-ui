...
describe('HistoryAccumulator', () => {
	test.todo('HistoryAccumulator tests');
	// test('Add and return messages', () => {
	// 	HistoryAccumulator.pushToCache(room1.id, textMessage1);
	// 	HistoryAccumulator.pushToCache(room1.id, textMessage2);
	// 	HistoryAccumulator.pushToCache(room2.id, textMessage3);
	// 	HistoryAccumulator.pushToCache(room2.id, textMessage4);
