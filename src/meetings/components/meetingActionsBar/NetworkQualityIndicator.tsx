			...
			<>
				<Snackbar
					label={t(
						...
						'Abbiamo rilevato che la tua connessione potrebbe influire sulla qualità della videoconferenza. Per offrirti un’esperienza più fluida, il video degli altri partecipanti verrà temporaneamente disattivato.'
					)}
					severity="warning"
