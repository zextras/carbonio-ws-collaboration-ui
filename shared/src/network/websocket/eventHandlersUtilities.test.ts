...
export const meetingEvents = [
	...
	WsEventType.MEETING_PARTICIPANT_JOINED,
	WsEventType.MEETING_PARTICIPANT_LEFT,
	...
	WsEventType.MEETING_WAITING_PARTICIPANT_ACCEPTED,
	WsEventType.MEETING_WAITING_PARTICIPANT_REJECTED,
...
describe('eventHandlersUtilities tests', () => {
	...
	describe('isMyId tests', () => {
		test('isMyId returns true if the id is the same as the session userId', () => {
			sharedConfig.useStore.getState().setLoginInfo({ id: 'userId', name: 'User' });
